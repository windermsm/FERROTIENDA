...
public class wdwMovimientoVentaDeProductos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnVale.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inventory/imagenes/invoice_w.png"))); // NOI18N
        btnVale.setToolTipText("Imprimir Vale");
        btnVale.setActionCommand("imprimirEnvio");
        ...
        pnlBotonesLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlBotonesLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnVale, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    */
                    if (txtIdFactura.getText().equals("")){
                        ...
                        if(verificarDatosFactura(Factura)){
                            ...
                            System.out.println("SE INSERTO LA FACTURA NO: "+Factura.getNumero_factura()+" DEL CLIENTE : "+Factura.getId_cliente());
                        }else{
                        ...
                        try {
                            ...
                            if(error_grabar==false){
                                ...
                                Mensaje.manipulacionExcepciones("informacion","Venta guardada exitosamente.");
                            }
                        ...
                        Mensaje.manipulacionExcepciones("critico", "Esta factura ya fue guardada con anterioridad.");
                    }
    ...
    private void btnValeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValeActionPerformed
        try {
            AccesoInventario Acceso = new AccesoInventario();
            URL url_reporte = this.getClass().getResource("/inventory/reportes/rptValeDoble.jasper");
            JasperReport reporte = (JasperReport) JRLoader.loadObject(url_reporte);
            //ENVIAR EL PARAMETRO AL REPORTES
            HashMap parametro = new HashMap();
            parametro.put("P_ID_FACTURA", Integer.parseInt(txtIdFactura.getText()));
